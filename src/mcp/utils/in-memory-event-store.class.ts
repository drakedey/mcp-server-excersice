...
// This is something I grab from https://www.claube.ai/docs/streamable-http and is a simple implementation for 
// production we should grab something more robust with actually in memory management i.e a database
